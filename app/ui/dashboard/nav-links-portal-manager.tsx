    ...
    <>
      {links.map((link) => {
        ...
        return (
          ...
          href={link.href}
          className={clsx(
            'flex h-[48px] grow items-center justify-center gap-2 rounded-md p-3 text-sm font-medium hover:text-orange-700 hover:bg-primarybg-dark md:flex-none md:justify-start md:p-2 md:px-3',
            {
